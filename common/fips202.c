...
extern unsigned long long hash_calls;
unsigned long long hash_overflowcnt;
unsigned long long hash_cycles_tmp;

extern unsigned long long sum_input_len;
extern unsigned long long sum_output_len;
#endif
...
{
  #ifdef PROFILE_HASHING
  hash_cycles_tmp = systick_get_value();
  hash_overflowcnt = overflowcnt;
  hash_calls++;
  #endif
  ...
  #ifdef PROFILE_HASHING
  hash_cycles += (hash_cycles_tmp+(overflowcnt-hash_overflowcnt)*2400000llu)-systick_get_value();
  #endif
}
